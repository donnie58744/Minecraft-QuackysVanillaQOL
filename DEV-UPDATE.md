...
5. Zip up the following folders for **Client** `config/`,`mods/`,`resourcepacks/`,`shaderpacks/` name it the following `QuackysVanillaQOL-x.x.x.zip`
6. Zip up the following folders for **Server** `config/`,`mods/` name it the following `QuackysVanillaQOL_Server-x.x.x.zip`
